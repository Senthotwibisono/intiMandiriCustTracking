...
const container = location.state?.data.container;
const job = location.state?.data.job;
const customer = location.state?.data.customer;
const tglMasuk = container.tglmasuk ?? 'Belum Masuk';
const tglKeluar = container.tglkeluar ?? 'Belum Keluar';
const dokumen = container.dokumen?.name ?? 'Belum tersedia';
const spjm = container.jenis_spjm ?? 'Belum tersedia';
const photos = location.state?.data.photos;
        ...
        <div  key="1" className="bg-white shadow-lg rounded-lg p-6 max-w-xl w-full">
            <div className="bg-white shadow-lg rounded-lg p-6 max-w-xl w-full">
              <div className="px-4 sm:px-0">
                <h3 className="text-base/7 font-semibold text-gray-900">Containers Information</h3>
                <p className="mt-1 max-w-2xl text-sm/6 text-gray-500">Containers details and application.</p>
              </div>
                <div className="mt-6 border-t border-gray-100">
                    <dl className="divide-y divide-gray-100">
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          <dt className="text-sm/6 font-medium text-gray-900">Bill of Loading AWB</dt>
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{container.nobl} - {container.tgl_bl_awb}</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          <dt className="text-sm/6 font-medium text-gray-900">Contianers</dt>
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{container.nocontainer} - {container.size} Feet - {container.ctr_type}</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          ...
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{tglMasuk} - {container.jammasuk}</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          <dt className="text-sm/6 font-medium text-gray-900">Dokumen Pengeluaran</dt>
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{dokumen} - {container.no_dok} - {container.tgl_dok}</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          <dt className="text-sm/6 font-medium text-gray-900">Tgl Keluar</dt>
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{tglKeluar} - {container.jamkeluar}</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          ...
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{spjm} - {container.no_spjm} - {container.tgl_spjm}</dd>
                          <dt className="text-sm/6 font-medium text-gray-900"></dt>
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">Selesai Behandle Pd {container.date_ready_behandle} - {container.date_finish_behandle}</dd>
                          <dt className="text-sm/6 font-medium text-gray-900"></dt>
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">Dg Catatan :  {container.desc_finish_behandle}</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          <dt className="text-sm/6 font-medium text-gray-900">Segel Merah</dt>
                          <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">{container.nosegel} - {container.tanggal_segel_merah}</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <button 
                                onClick={handlePrint}
